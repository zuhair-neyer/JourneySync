...
import { ListChecks, MapPin, Sparkles, Luggage, UsersRound, Home, DollarSign, PlaneTakeoff } from "lucide-react"; // Added PlaneTakeoff
...
const navItems = [
  ...
  { href: "/trips", label: "My Trips", icon: PlaneTakeoff }, // Added Trips link
